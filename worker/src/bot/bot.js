...
import { resumoJornada, resumoPlantel } from './mensagens.js';
...
if (bot) {
  ...
  bot.command('boletim', async (ctx) => {
    ...
    await ctx.reply(resumoJornada(b), { parse_mode: 'Markdown' });
  });
